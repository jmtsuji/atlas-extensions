...
# Build and push with:
# docker build -t jmtsuji/atlas-extensions:1.0.22-coassembly-r3 -t jmtsuji/atlas-extensions:1.0.22-coassembly-latest https://github.com/jmtsuji/atlas-extensions.git#1.0.22-coassembly-r3
